...
import com.shambhu.myapplication.databinding.FragmentKarmicLessonBinding
 ...
 */
class KarmicLessonFragment : Fragment() {

    private var _binding: FragmentKarmicLessonBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKarmicLessonBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (fullName != null) {
                binding.tvKarmicByNameValue.text = NumerologyCalculationUtils.calculateKarmicLesson(fullName).joinToString(", ")
            }
        }
    }
    ...
    companion object {
        ...
        ): KarmicLessonFragment {
            val fragment = KarmicLessonFragment()
            val args = Bundle()
